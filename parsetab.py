...
_lr_goto_items = {'declarationList':([0,2,70,103,107,],[1,29,87,108,109,]),'declaration':([0,2,70,103,107,],[2,2,2,2,2,]),'varDeclaration':([0,2,70,103,107,],[3,3,3,3,3,]),'statement':([0,2,70,103,107,],[4,4,4,4,4,]),'expressionStmt':([0,2,14,31,45,70,103,107,],[6,6,38,62,62,6,6,6,]),'conditionalStmt':([0,2,70,103,107,],[7,7,7,7,7,]),'iterationStmt':([0,2,70,103,107,],[8,8,8,8,8,]),'functionalStmt':([0,2,31,45,70,103,107,],[9,9,66,66,9,9,9,]),'inputStmt':([0,2,31,45,70,103,107,],[10,10,65,65,10,10,10,]),'outputStmt':([0,2,70,103,107,],[11,11,11,11,11,]),'commentStmt':([0,2,70,103,107,],[12,12,12,12,12,]),'andExpression':([0,2,14,31,33,45,70,103,107,],[13,13,13,13,68,13,13,13,13,]),'unaryRelExpression':([0,2,14,23,31,33,37,45,70,103,107,],[22,22,22,46,22,22,69,22,22,22,22,]),'relExpression':([0,2,14,23,31,33,37,45,70,92,96,103,107,],[24,24,24,24,24,24,24,24,24,104,106,24,24,]),'sumExpression':([0,2,14,23,31,33,37,45,47,70,92,94,96,103,107,],[25,25,25,25,25,25,25,25,80,25,25,105,25,25,25,]),'term':([0,2,14,23,31,33,37,45,47,48,70,92,94,96,103,107,],[26,26,26,26,26,26,26,26,26,81,26,26,26,26,26,26,]),'sumElement':([0,2,14,23,31,33,37,45,47,48,57,70,92,94,96,103,107,],[27,27,27,27,27,27,27,27,27,27,82,27,27,27,27,27,27,]),'relop':([25,],[47,]),'sumop':([25,80,105,],[48,48,48,]),'mulop':([26,81,],[57,57,]),'declarationElement':([31,45,],[60,79,]),'list':([31,45,71,],[61,61,90,]),'lambdaFilter':([41,],[72,]),'lambdaMap':([42,],[74,]),'lambdaReduce':([43,],[76,]),'listElements':([67,],[83,]),'iterationElement':([71,],[89,]),}
...
_lr_productions = [
  ...
  ('declarationElement -> expressionStmt','declarationElement',1,'p_declarationElement','interpreter.py',176),
